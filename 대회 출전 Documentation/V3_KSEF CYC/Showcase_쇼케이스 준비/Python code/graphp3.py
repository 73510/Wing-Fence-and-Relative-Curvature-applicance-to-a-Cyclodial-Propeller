...
x_scale = 500  # For example, every 500 RPM
y_scale = 100   # For example, every 10 grams
max_x_axis_value = 5500  # Adjust this as needed for the expected RPM range
max_y_axis_value = 550
...
while True:
    ...
    if testing:
        ...
        if time.time() - last_data_time >= 1 and current_data_point < test_data_points:
            ...
            send_thrust_to_arduino(3*current_data_point+60)

            print(3*current_data_point+60)
